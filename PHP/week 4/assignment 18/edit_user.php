    ...
    <main>
        ...
        <div id='form-div'>
            <form class='form' method="post">
                ...
                <!-- regular expression validation to the email field -->
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" value="<?php echo $email; ?>" pattern="^[^0-9][A-z0-9_]+([.][A-z0-9_]+)*[@][A-z0-9_]+([.][A-z0-9_]+)*[.][A-z]{2,4}$" required><br>
